...
nohup $JAVA \
	...
	-Da2.log4j.configuration=$A2_LOG_HOME/conf/log4j.properties eu.solutions.a2.logs.oracle.adr.OraAdrProducer \
	$A2_LOG_HOME/conf/oraadr-producer.conf </dev/null 2>&1 | tee $A2_LOG_HOME/log/oraadr-producer.log &
